		...
		btn_update.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if(StringUtils.isEmpty(old_pwd)){
					ToastUtils.showToast(ForgetPwdActivity.this, "请输入旧密码");
					return;
				}
				if(StringUtils.isEmpty(new_pwd)){
					ToastUtils.showToast(ForgetPwdActivity.this, "请输入新密码");
					return;
				}
				if(StringUtils.isEmpty(new_pwd2)){
					ToastUtils.showToast(ForgetPwdActivity.this, "请再次输入密码");
					return;
				}
				if(!new_pwd.equals(new_pwd2)){
					ToastUtils.showToast(ForgetPwdActivity.this, "两次密码不一致");
					return;
				}
