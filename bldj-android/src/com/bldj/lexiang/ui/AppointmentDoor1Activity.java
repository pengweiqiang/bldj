 ...
 * 
 */
public class AppointmentDoor1Activity extends BaseActivity implements IXListViewListener{
	...
	public void initView() {
		...
		listAdapter = new JlysHealthAdapter(AppointmentDoor1Activity.this, sellers);
...
//				intent.putExtra("seller", products.get(position));
	...
	private void getSellers() {
		ApiProductUtils.getProducts(AppointmentDoor1Activity.this, "1", 2,
