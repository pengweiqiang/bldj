...
//		gridView = (GridView) findViewById(R.id.gridview);
	...
	TextView tv_first_date, tv_seconde_date, tv_third_date, tv_four_date,
	 ...
	 View time1, time2, time3, time4, time5, time6, time7, time8, time9,
	 time10,
	 time11, time12, time13, time14, time15, time16;
	 TextView
	 timeStatus1,timeStatus2,timeStatus3,timeStatus4,timeStatus5,timeStatus6,timeStatus7,timeStatus8,
	...
	private void initScheduledView() {
		...
		tv_five_date.setOnClickListener(dateClickListener);
		 ...
		 time1.setTag(time1.getId(), 0);time2.setTag(time2.getId(), 1);
		 time3.setTag(time3.getId(), 2);time4.setTag(time4.getId(), 3);
		 time5.setTag(time5.getId(), 4);time6.setTag(time6.getId(), 5);
		 time7.setTag(time7.getId(), 6);time8.setTag(time8.getId(), 7);
		 time9.setTag(time9.getId(), 8);time10.setTag(time10.getId(), 9);
		 time11.setTag(time11.getId(), 10);time12.setTag(time12.getId(), 11);
		 time13.setTag(time13.getId(), 12);time14.setTag(time14.getId(), 13);
		 time15.setTag(time15.getId(), 14);time16.setTag(time16.getId(), 15);
