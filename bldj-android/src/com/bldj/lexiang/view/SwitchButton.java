...
public class SwitchButton extends CheckBox {
    ...
    private void initView(Context context) {
        ...
        // get Bitmap
        mBottom = CommonHelper.getAssertBitmap(context,"app_store/bottom.png");
        mBtnPressed = CommonHelper.getAssertBitmap(context,"app_store/btn_pressed.png");
        mBtnNormal = CommonHelper.getAssertBitmap(context,"app_store/btn_unpressed.png");
        mFrame = CommonHelper.getAssertBitmap(context,"app_store/frame.png");
        mMask = CommonHelper.getAssertBitmap(context,"app_store/mask.png");
