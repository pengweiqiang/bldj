 ...
 *******************************************************************************/
package com.bldj.universalimageloader.core;
...
import com.bldj.universalimageloader.cache.disc.DiscCacheAware;
import com.bldj.universalimageloader.cache.disc.impl.UnlimitedDiscCache;
import com.bldj.universalimageloader.cache.disc.naming.FileNameGenerator;
import com.bldj.universalimageloader.cache.memory.MemoryCacheAware;
import com.bldj.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.bldj.universalimageloader.core.assist.ImageSize;
import com.bldj.universalimageloader.core.assist.QueueProcessingType;
import com.bldj.universalimageloader.core.decode.ImageDecoder;
import com.bldj.universalimageloader.core.download.ImageDownloader;
import com.bldj.universalimageloader.core.download.NetworkDeniedImageDownloader;
import com.bldj.universalimageloader.core.download.SlowNetworkImageDownloader;
import com.bldj.universalimageloader.core.process.BitmapProcessor;
import com.bldj.universalimageloader.utils.L;
import com.bldj.universalimageloader.utils.MemoryCacheUtils;
import com.bldj.universalimageloader.utils.StorageUtils;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link com.bldj.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.bldj.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.bldj.universalimageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.bldj.universalimageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link com.bldj.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link com.bldj.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.bldj.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link com.bldj.universalimageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link com.bldj.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link com.bldj.universalimageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
