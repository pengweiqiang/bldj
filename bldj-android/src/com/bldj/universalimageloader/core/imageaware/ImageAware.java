 ...
 *******************************************************************************/
package com.bldj.universalimageloader.core.imageaware;
 ...
 * through {@link com.bldj.universalimageloader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.bldj.universalimageloader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.bldj.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.bldj.universalimageloader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.bldj.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.bldj.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.bldj.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.bldj.universalimageloader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.bldj.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
	 ...
	 * {@link com.bldj.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.
	 *
